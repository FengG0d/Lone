...
import static net.ccbluex.liquidbounce.utils.extensions.RendererExtensionKt.drawCenteredString;
...
public class VisualUtils extends MinecraftInstance {
    ...
    public static int drawText(String text, FontRenderer fontRenderer, int width, int height, float scale, int color, boolean center, boolean shadow) {
        ...
        int length = 0;
        if (center) {
            length = drawCenteredString(fontRenderer, text, Math.round(width / scale), Math.round(height / scale), color, shadow);
        } else {
    ...
    public static void drawTexturedRectWithCustomAlpha(float x, float y, float width, float height, String image, float alpha) {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("iceshadow/shadow/" + image + ".png"));
