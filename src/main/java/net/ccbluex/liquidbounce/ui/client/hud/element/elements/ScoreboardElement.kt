...
class ScoreboardElement(
    ...
    private val rectColorModeValue =
        ListValue("Color", arrayOf("Custom", "Rainbow", "LiquidSlowly", "Fade", "Sky", "Gident"), "Custom")
    ...
    override fun drawElement(partialTicks: Float): Border? {
        ...
        var FadeColor: Int = Palette.fade2(
            Color(rectColorRedValue.get(), rectColorGreenValue.get(), rectColorBlueValue.get()),
            counter[0] * 100,
            114514
        ).rgb

        val LiquidSlowly =
            ColorUtils.slowlyRainbow(System.nanoTime(), 0, saturationValue.get(), brightnessValue.get()).rgb
        ...
        if (rectValue.get() && scoreCollection.size > 0) {
            val rectColor = when {
                rectColorMode.equals("Sky", ignoreCase = true) -> ColorUtils.skyRainbow(
                    0,
                    saturationValue.get(),
                    brightnessValue.get(),
                    5.0
                ...
                rectColorMode.equals("Gident", true) -> VisualUtils.getGradientOffset(
                    Color(
                ...
                for (z in name.indices) {
                    ...
                    if (side.horizontal == Side.Horizontal.LEFT)
                        fontRenderer.drawString(
                            name.get(z).toString(),
                            -3F + fontRenderer.getStringWidth(stringZ).toFloat(),
                            height.toFloat(),
                            typeColor,
                            shadowValue.get()
                        )
                        ...
                        fontRenderer.drawString(
                            name.get(z).toString(),
                            l1.toFloat() + fontRenderer.getStringWidth(stringZ),
                            height.toFloat(),
                            typeColor,
                            shadowValue.get()
                        )
