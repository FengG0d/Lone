...
object GradientBackground {
    ...
    init {
        ...
        val json = JsonParser().parse(GradientBackground::class.java.classLoader.getResourceAsStream("assets/minecraft/lone/misc/gradient.json").reader(Charsets.UTF_8)).asJsonArray
        json.forEach {
